...
/**
 * This class is a swing component which shows a loading panel when you call initLoading()
 * and is able to switch to the loaded content when you call finishedLoading()
 * 
...
public class LoadingContentPane extends JPanel implements ProgressThreadListener {
	...
	/** This method should only be called from the ProgressThread when it's finished. Causes the LoadingContentPane to
	 * switch to the actual content pane. **/
	@Override
